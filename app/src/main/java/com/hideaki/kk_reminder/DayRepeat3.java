...
public class DayRepeat3 implements Serializable, Cloneable {

  private static final long serialVersionUID = 8197596806122428882L;
  ...
  private Calendar timeLimit = null;
  ...
  @NonNull
  @Override
  public DayRepeat3 clone() {

    try {
      return (DayRepeat3)super.clone();
    }
