...
import static com.example.hideaki.reminder.UtilClass.RC_SIGN_IN;
...
public class BackupAndRestoreFragment extends PreferenceFragment implements Preference.OnPreferenceClickListener {
  ...
  private static final String DATABASE_PATH = "/data/data/com.example.hideaki.reminder/databases/";
